...
@section('content')
    <div class="main-content-wrap">
        ...
        <!-- New Brand Form -->
        <div class="wg-box">
            <form class="form-new-product form-style-1" action="{{ route('admin.store-brands') }}" method="POST"
                ...
                <fieldset class="name">
                    ...
                    <input class="flex-grow @error('slug') is-invalid @enderror" type="text" placeholder="Brand slug" name="slug" required>
