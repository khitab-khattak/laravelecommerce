        ...
        <div class="main-content-wrap">
            ...
            <div class="wg-box">
                <div class="flex items-center justify-between gap10 flex-wrap">
                    ...
                    <a class="tf-button style-1 w208" href="{{ route('coupons.add') }}"><i class="icon-plus"></i>Add new</a>
                </div>
                                ...
                                @foreach ($coupons as $coupon)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            data-bs-target="#confirmModal-{{ $coupon->id }}"
                                        ...
                                        <form action="{{ route('coupons.delete', $coupon->id) }}"
                                            ...
                                            <div class="modal fade" id="confirmModal-{{ $coupon->id }}"
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body text-center">
                                                            ...
                                                            <p class="mb-0">Are you sure you want to delete this
                                                                Coupon?<br>This action cannot be undone.</p>
                                                        </div>
